                            ...
                            <div class="">
                                ...
                                <div class="px-4 py-5 sm:p-6">
                                    <div class="grid grid-cols-6 gap-6">
                                        ...
                                        {{-- 2 --}}
                                        {{-- integ.page my service 1 mnt 6 #12 A --}}
                                        ...
                                        {{-- 3 mnt 8 inegration page service 1 #12 A--}}
                                        <div class="col-span-6">
                                        ...
                                        {{-- 4 mnt 1 inegration page service 2 #12 A--}}
                                        <div class="col-span-6">
...
{{-- 4 mnt 1-3 integration page service 2 #12 A--}}
    <script type="text/javascript">
        // add row
